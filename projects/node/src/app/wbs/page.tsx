        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="max-w-7xl mx-auto my-8">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div className="grid grid-cols-12 gap-4 font-bold text-sm bg-gradient-to-r from-blue-50 to-purple-50 py-4 px-8 border-b-2 border-gray-200">
                        ...
                        <div className="col-span-2 text-right">バッファ込み</div>
                    </div>
                    <WbsRow
                        node={calcedRoot}
                        depth={0}
