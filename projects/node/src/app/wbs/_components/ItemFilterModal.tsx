    ...
    return (
        <>
            ...
            <div className="fixed inset-0 bg-gray-900/50 flex items-center justify-center z-50" onClick={onClose}>
                ...
                <div className="flex flex-col bg-white rounded-lg p-8 max-w-2xl w-full h-2/3 overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="mt-6 text-right">
                        <button type="button" className="px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300" onClick={onClose}>
                            閉じる
                        </button>
                    </div>
                </div>
